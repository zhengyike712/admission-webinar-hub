...
const T: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    onboardingF1Desc: "美国、英国、香港、澳大利亚、加拿大顶尖院校，持续扩展中",
  ...
  en: {
    ...
    onboardingF1Desc: "US, UK, Hong Kong, Australia, Canada — and growing",
  ...
  hi: {
    ...
    onboardingF1Desc: "अमेरिका, यूके, हांगकांग, ऑस्ट्रेलिया, कनाडा — और बढ़ता हुआ",
